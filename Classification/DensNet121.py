...
from torchvision.models import DenseNet169_Weights, DenseNet121_Weights
...
def main():
    ...
    if os.path.isfile("Models/DensNet.pth"):
        ...
        checkpoint = torch.load("Models/DensNet.pth")
...
def save_final_model(model, optimizer, epoch):
    ...
    checkpoint_path = "Models/DensNet.pth"  # Save the final model
    state = {
